...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('section', [_c('el-form', {
    ...
    on: {
      "row-click": _vm.rowlick,
      "cell-click": _vm.rowClick
    }
  }, [_c('el-table-column', {
    attrs: {
      "align": "center",
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function(scope) {
        return [_c('el-button', {
          ...
          on: {
            "click": function($event) {
              return _vm.setVIP(scope.row, 1)
            }
          }
        }, [_vm._v("VIP")]), _vm._v(" "), _c('el-button', {
          attrs: {
            "type": "small"
          },
          on: {
            "click": function($event) {
              return _vm.setVIP(scope.row, 2)
            }
          }
        }, [_vm._v("超级VIP")])]
      }
...
var domain = location.origin.indexOf('localhost') > -1 ? 'taobao.tianyalei.com' : location.origin;
      ...
      this.axios({
        ...
        if (response.data.code == 200) {
          ...
          that.dataList.forEach((item, index) => {
            that.dataList[index].vipText = that.vip2Text(item.vip);
          });
          that.total = response.data.data.totalCount;
        }
      });
...
//# sourceMappingURL=app.0570682c26d10b885f4d.js.map